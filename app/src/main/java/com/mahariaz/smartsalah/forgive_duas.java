...
public class forgive_duas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgive_duas);
        ...
        final TabLayoutAdapterForgive adapter = new TabLayoutAdapterForgive(this, getSupportFragmentManager(), tabLayout.getTabCount());

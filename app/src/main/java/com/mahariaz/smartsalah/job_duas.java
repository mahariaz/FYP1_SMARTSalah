...
public class job_duas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_duas);
        ...
        final TabLayoutAdapterJob adapter = new TabLayoutAdapterJob(this, getSupportFragmentManager(), tabLayout.getTabCount());
